  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center flex-col mt-20">
        ...
        <button className="mt-4 flex justify-center items-center w-[230px] text-[14px] gap-2 text-[#292929] rounded-[30px] border-2 p-3 border-[#a8a8a8]" onClick={handleGithubSignUp}>
      ...
      <p className="text-center mt-28 px-24 text-[#8d8d8d]">
        <small className="">
          ...
          and acknoledge that Meduims's <a href="#">Privacy Policy.</a> applies
          to you.
        </small>
      </p>
    </>
